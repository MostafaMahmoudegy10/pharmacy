...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyle = "relative inline-flex items-center justify-center font-medium rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary active-spring disabled:opacity-50 disabled:pointer-events-none";
  ...
  const variants = {
    ...
    danger: "bg-danger text-white hover:bg-danger-hover focus:ring-danger shadow-sm shadow-danger/20",
    warning: "bg-warning text-white hover:bg-warning-hover focus:ring-warning shadow-sm shadow-warning/20",
